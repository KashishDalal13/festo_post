...
export 'package:festo_post/utils/routes.dart';
export 'package:festo_post/utils/string.dart';
export 'package:festo_post/utils/text_style.dart';
export 'package:festo_post/utils/theme.dart';

//theme_chnage
export 'package:festo_post/theme_change/theme_settings.dart';

//shared
export 'package:festo_post/shared/injector.dart';
export 'package:festo_post/shared/prefs_key.dart';

//provider
export 'package:festo_post/module/splash_module/provider/splash_screen_provider.dart';
...
export 'package:festo_post/module/profile_module/view/profile_view.dart';
export 'package:festo_post/module/on_boarding/on_boarding_info.dart';
export 'package:festo_post/module/on_boarding/on_boarding_view.dart';
export 'package:festo_post/module/login_module/view/add_details_view.dart';
export 'package:festo_post/module/login_module/view/otp_view.dart';
export 'package:festo_post/module/login_module/view/referral_view.dart';
