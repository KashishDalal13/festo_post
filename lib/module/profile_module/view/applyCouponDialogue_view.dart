              ...
              child: Column(
                ...
                children: [
                    ...
                    child: Container(
                      ...
                      child: IconButton(
                        ...
                        icon: Icon(
                          Icons.close,
                          size: 18,
                          color: BoolRef.themeChange ? ColorRef.yellowFFA500 : ColorRef.blue0250A4,
                        ),
                      ),
                    ),
                  ),
                  ...
                  Text(
                    ...
                    style: TextStyle(color: ColorRef.textPrimaryColor, fontWeight: FontWeight.w400, fontSize: 15, fontFamily: 'Lato'),
                  ),
                  const SizedBox(
                    height: 20,
                  ),
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(color: BoolRef.themeChange ? ColorRef.transparent : ColorRef.greyCACACA),
                              ...
                              Row(
                                children: [
                                  ...
                                  Flexible(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          item["offerCode"],
                                          style: TextStyle(color: BoolRef.themeChange ? ColorRef.greyEAEAEA : ColorRef.grey838383, fontWeight: FontWeight.w400, fontSize: 12, fontFamily: 'Lato'),
                                        ),
                                      ],
                                    ),
                                  ),
                                  ...
                                  Padding(
                                      ...
                                      child: Text(
                                        StrRef.apply,
                                        style: TextStyle(fontFamily: 'Lato', fontSize: 16, fontWeight: FontWeight.w500, color: BoolRef.themeChange ? ColorRef.yellowFFA500 : ColorRef.blue0250A4),
                                      )),
                                ],
                              ),
                            ],
